...
export const LessonView: React.FC<Props> = ({ lesson, subject, onNavigateToSimLab }) => {
  ...
  return (
    <main className="flex-1 min-w-0 p-6 lg:p-8 space-y-6 max-w-4xl">
      {/* Lesson Header */}
      <div className="space-y-2 border-b border-slate-800 pb-5">
        <div className="flex items-center gap-2 text-xs font-mono text-slate-400">
          ...
          <span>•</span>
          <span className="text-sky-400">Kết nối tri thức với cuộc sống</span>
        </div>
      ...
      <div className="bg-gradient-to-r from-amber-950/20 via-slate-900 to-slate-900 border-l-4 border-amber-500 p-5 rounded-r-xl shadow-md space-y-3">
        ...
        <div className="text-sm text-amber-200/90 font-medium italic">
        ...
        <div className="text-xs text-slate-400 pt-1 border-t border-slate-800/60">
          <strong className="text-slate-300">Ý nghĩa thực tiễn: </strong>
        ...
        <div className="flex items-center justify-between">
          ...
          {lesson.simulationId && (
            <button
              ...
              className="flex items-center gap-1.5 text-xs text-sky-400 hover:text-sky-300 hover:underline font-mono"
            >
      ...
      <div className="space-y-4 pt-4 border-t border-slate-800">
        ...
        {lesson.keyFormulaLatex && (
          <div className="p-4 bg-[#0b0f17] border border-slate-800 rounded-xl font-mono text-emerald-400 text-sm overflow-x-auto text-center">
